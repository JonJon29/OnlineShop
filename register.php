...
<body>
    ...
    if(isset($_GET['register'])) {
        ...
        if(!$error) {    
            ...
            $sql = 'INSERT INTO Costumer (name, lastname, street, zipcode, city, bankaccount, blz, institut, password, email) VALUES ("Jonas", "Moller", "Tannehof", 36103, "Flieden", 123, 123, "Fulda", "123", "mailo")';
            $result = $conn->query($sql);
